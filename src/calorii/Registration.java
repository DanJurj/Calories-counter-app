...
public class Registration extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            PreparedStatement str=c.con.prepareStatement("insert into users(Username, Password, Email, First_Name, Last_Name) values(?,?,?,?,?)");
            str.setString(1, username);
            str.setString(2,password);
            str.setString(3,email);
            str.setString(4,first_name );
            str.setString(5,last_name);
            int b = str.executeUpdate();
            JOptionPane.showMessageDialog(this, "Your Registration Id is complete!:");
        }
        catch(Exception e)
        {
