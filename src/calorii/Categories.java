...
public class Categories extends javax.swing.JFrame {
    ...
    public Categories() {
        ...
        try
        {
            ...
            while(rs.next())
            {
                categories=categories+rs.getString("Name")+ "\n";
            }
            jTextArea1.setText(categories);
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter the new Category Name:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            PreparedStatement str1 = c.con.prepareStatement("Insert Into categories(Name) Values ('"+ categorie + "')");
            str1.executeUpdate();
